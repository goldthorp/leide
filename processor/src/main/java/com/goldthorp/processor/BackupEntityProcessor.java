package com.goldthorp.processor;
 ...
 * which is used to read/write the local database from com.goldthorp.wisebison.Backup
 */
@SupportedAnnotationTypes("com.goldthorp.annotation.BackupEntity")
  ...
  public boolean process(
    ...
    try {
      final JavaFileObject javaFileObject = processingEnv.getFiler()
        .createSourceFile("com.goldthorp.wisebison.data.BackupEntityGeneratedDao");
